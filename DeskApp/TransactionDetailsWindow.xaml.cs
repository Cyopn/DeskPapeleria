...
namespace DeskApp
{
    public partial class TransactionDetailsWindow : Window
    {
        ...
        public string HeaderLine => $"Transacci�n #{Transaction.IdTransaction} � {Transaction.Type} � {Transaction.Total:C}";
        ...
        private async void PrintFilesButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (printedCount == 0)
                {
                    ToastNotification.Show("No se pudo enviar ning�n archivo a impresi�n", ToastType.Error, 4);
                    return;
                }
                ...
                {
                    ToastNotification.Show("Impresi�n completada y archivos marcados como inactivos", ToastType.Success, 4);
                }
                else
                {
                    ToastNotification.Show("Impresi�n completada, pero hubo errores al actualizar algunos archivos", ToastType.Warning, 4);
                }
            }
            catch (Exception ex)
            {
        ...
        private async void CompletePurchaseButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ToastNotification.Show("La transacci�n ya est� completada", ToastType.Info, 3);
                return;
            }
        ...
        private async void CompleteSpecialServiceButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ToastNotification.Show("Se complet� el servicio especial, pero hubo errores en algunos productos", ToastType.Warning, 4);
                }
